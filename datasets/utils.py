...
def get_train_dataset(data_root, data_list, input_size, args, return_path=False):
    ...
    _dataset = get_dataset(data_root, data_list, args, transforms1=transforms1, transforms2=transforms2, is_train=True,
                           return_path=return_path)
    return _dataset
...
def get_val_dataset(data_root, data_list, input_size, args, return_path=False):
    ...
    _dataset = get_dataset(data_root, data_list, args, transforms1=transforms1, transforms2=transforms2, is_train=False,
                           return_path=return_path)
    return _dataset
